...
Route::middleware(['auth'])->group(function () {
    ...
    Route::group(['prefix' => 'user', 'middleware' => 'authorize:ADM'], function () {
        ...
        Route::get('/{id}/show_ajax', [UserController::class, 'show_ajax']);        //menampilkan detail ajax
    ...
    Route::group(['prefix' => 'level', 'middleware' => 'authorize:ADM,MNG'], function () {
        ...
        Route::get('/{id}/show_ajax', [LevelController::class, 'show_ajax']);        //menampilkan detail ajax
    ...
    Route::group(['prefix' => 'kategori', 'middleware' => 'authorize:ADM,MNG'], function () {
        ...
        Route::get('/{id}/show_ajax', [KategoriController::class, 'show_ajax']);        //menampilkan detail ajax
    ...
    Route::group(['prefix' => 'supplier', 'middleware' => 'authorize:ADM'], function () {
        ...
        Route::get('/{id}/show_ajax', [SupplierController::class, 'show_ajax']);        //menampilkan detail ajax
    ...
    Route::group(['prefix' => 'barang', 'middleware' => 'authorize:ADM,MNG'], function () {
        ...
        Route::get('/{id}/show_ajax', [BarangController::class, 'show_ajax']);        //menampilkan detail ajax
